...
$url="paq_europa.php";
	...
	$rst_destinos=mysql_query("SELECT * FROM jk_paquetes WHERE id>0 and tipo_paquete=6 order by destino asc;", $conexion);
	...
	$rst_destinos=mysql_query("SELECT * FROM jk_paquetes WHERE id>0 and tipo_paquete=6 order by destino asc LIMIT $inicio, $registros;", $conexion);
...
<div id="principal">
    ...
    <div id="banner_logo"> 
      <object id="FlashID3" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="1000" height="200">
        <param name="movie" value="flash/banner_superior_europa.swf" />
        <param name="quality" value="high" />
        ...
        <!-- La siguiente etiqueta object es para navegadores distintos de IE. Ocúltela a IE mediante IECC. -->
        <!--[if !IE]>-->
        <object type="application/x-shockwave-flash" data="flash/banner_superior_europa.swf" width="1000" height="200">
          <!--<![endif]-->
          <param name="quality" value="high" />
          <param name="wmode" value="opaque" />
          <param name="swfversion" value="6.0.65.0" />
            ...
            <div id="contenido_total">
                ...
                <div id="fnd_med_contenido">
                    ...
                    <div id="panel_der">
                        ...
                        <div class="full_day" id="full_day">Europa
