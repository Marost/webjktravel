...
$url="prom_nacional.php";

	$rst_destinos=mysql_query("SELECT * FROM jk_paquetes WHERE id>0 and tipo_paquete=5 order by destino asc;", $conexion);
	...
	$rst_destinos=mysql_query("SELECT * FROM jk_paquetes WHERE id>0 and tipo_paquete=5 order by destino asc LIMIT $inicio, $registros;", $conexion);
        ...
        <!--<![endif]-->
            ...
            <div id="contenido_total">
                ...
                <div id="fnd_med_contenido">
                    ...
                    <div id="panel_der">
                    	<div id="paq_inter_nacional">
                        	<p class="texto_blanco texto_t14 texto_bold padding_b10 texto_derecha">
                        	  <object id="FlashID4" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="305" height="25">
                        	    <param name="movie" value="flash/texto_prom_inter.swf" />
                        	    <param name="quality" value="high" />
                        	    <param name="wmode" value="transparent" />
                        	    ...
                        	    <!-- La siguiente etiqueta object es para navegadores distintos de IE. Ocúltela a IE mediante IECC. -->
                        	    <!--[if !IE]>-->
                        	    <object type="application/x-shockwave-flash" data="flash/texto_prom_inter.swf" width="305" height="25">
                        	      <!--<![endif]-->
                        	      <param name="quality" value="high" />
                        	      <param name="wmode" value="transparent" />
                        	      <param name="swfversion" value="6.0.65.0" />
                        ...
                        <div class="full_day" id="full_day">Promociones Nacionales
                        </div><div id="fnd_inf_content_paq"></div><!--FIN FONDDO INFERIOR CONTENIDO PAQUETE-->
