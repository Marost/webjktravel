...
$url="full_days.php";
	...
	$rst_destinos=mysql_query("SELECT * FROM jk_paquetes WHERE id>0 and tipo_paquete=3 order by destino asc;", $conexion);
	...
	$rst_destinos=mysql_query("SELECT * FROM jk_paquetes WHERE id>0 and tipo_paquete=3 order by destino asc LIMIT $inicio, $registros;", $conexion);
...
<title>JK Travel - Agencia de Viajes y Turismo - Full Day</title>
            ...
            <div id="contenido_total">
                ...
                <div id="fnd_med_contenido">
                    ...
                    <div id="panel_der">
                        ...
                        <div class="full_day" id="full_day">Full Day</div>
