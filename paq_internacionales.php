...
$url="paq_internacionales.php";

	$rst_destinos=mysql_query("SELECT * FROM jk_paquetes WHERE id>0 and tipo_paquete=1 order by destino asc;", $conexion);
	...
	$rst_destinos=mysql_query("SELECT * FROM jk_paquetes WHERE id>0 and tipo_paquete=1 order by destino asc LIMIT $inicio, $registros;", $conexion);
...
<title>JK Travel - Agencia de Viajes y Turismo | <?php echo $num_registros["destino"]; ?></title>
...
<div id="principal">
    ...
    <div id="banner_logo">
    	<object id="FlashID3" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="1000" height="200">
    	  <param name="movie" value="flash/banner_superior_internacionales.swf" />
    	  <param name="quality" value="high" />
    	  ...
    	  <!-- La siguiente etiqueta object es para navegadores distintos de IE. Ocúltela a IE mediante IECC. -->
    	  <!--[if !IE]>-->
    	  <object type="application/x-shockwave-flash" data="flash/banner_superior_internacionales.swf" width="1000" height="200">
    	    <!--<![endif]-->
    	    <param name="quality" value="high" />
    	    <param name="wmode" value="opaque" />
    	    <param name="swfversion" value="6.0.65.0" />
                   	              ...
                   	              <form id="form3" name="form3" method="get" action="index.php">
                   	                <table width="80%" border="0" align="center" cellpadding="0" cellspacing="0">
                   	                  ...
                   	                  <tr>
                   	                    ...
                   	                    <td height="40"><span id="sprytextfield7">
                   	                  ...
                   	                  <tr>
                   	                    ...
                   	                    <td height="40"><span id="sprytextfield8">
                   	                      <label>
                   	                        <input name="retorno" type="text" id="retorno" value="<?php echo $_GET["retorno"];?>" /></label><br />
                   	                      <span class="textfieldRequiredMsg">Ingrese Fecha</span></span></td>
               	                      </tr>
                   	                  <tr>
                   	              ...
                   	              <form id="form4" name="form4" method="get" action="index.php">
                   	                <table width="80%" border="0" align="center" cellpadding="0" cellspacing="0">
                   	                  ...
                   	                  <tr>
                   	                    ...
                   	                    <td height="40"><span id="sprytextfield6"><span id="sprytextfield11"><span id="sprytextfield5"><span id="sprytextfield9">
                   	                  ...
                   	                  <tr>
                   	                    ...
                   	                    <td height="40"><span id="sprytextfield7"><span id="sprytextfield12"><span id="sprytextfield6"><span id="sprytextfield10">
                   	                      <label>
                    ...
                    <div id="panel_der">
                        ...
                        ?>                        
                            <div id="panel_paquetes">
                                ...
                                <div id="precio_paquetes">desde $ <?php echo $fila["precio"]; ?>.00</div>
