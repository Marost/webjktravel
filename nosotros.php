                   	              ...
                   	              <form id="form3" name="form3" method="get" action="index.php">
                   	                <table width="80%" border="0" align="center" cellpadding="0" cellspacing="0">
                   	                  ...
                   	                  <tr>
                   	                    ...
                   	                    <td height="40"><span id="sprytextfield4"><span id="sprytextfield9"><span id="sprytextfield2">
                   	                  ...
                   	                  <tr>
                   	                    ...
                   	                    <td height="40"><span id="sprytextfield5"><span id="sprytextfield10"><span id="sprytextfield3">
                   	                      <label>
                   	              ...
                   	              <form id="form4" name="form4" method="get" action="index.php">
                   	                <table width="80%" border="0" align="center" cellpadding="0" cellspacing="0">
                   	                  ...
                   	                  <tr>
                   	                    ...
                   	                    <td height="40"><span id="sprytextfield6"><span id="sprytextfield11"><span id="sprytextfield4">
                   	                  ...
                   	                  <tr>
                   	                    ...
                   	                    <td height="40"><span id="sprytextfield7"><span id="sprytextfield12"><span id="sprytextfield5">
                   	                      <label>
                            ...
                            <div id="fnd_med_content_paq"><!--FIN CABECERA CONTENIDO PAQUETE-->
                                <div id="cuerpo_contenido_paq">
                                	<div id="contenido_paq">
                                	  <p align="justify" class="titulo_nosotros">QUIENES SOMOS</p>
                                	  <p align="justify">&nbsp;                                      </p>
                                      <p class="texto_contenido"><strong>J&amp;K Travel</strong> es empresa de <strong>viajes</strong> y <strong>turismo</strong> registrada en el Ministerio de Comercio Exterior, Turismo (MINCETUR) y licenciataria de la Marca Peru.<br />
                               	      <br />
                               	      <strong>J&amp;K Travel</strong> es una <strong>agencia </strong> especializada en <strong>viajes turísticos</strong> Nacionales e Internacionales. Nuestra empresa se encuentra localizada geográficamente en Lima, Perú y desde aquí operamos nuestros viajes a los diferentes destinos solicitados para lograr su <strong>viaje</strong> anhelado.<br />
                               	      <br />
                               	      Nuestro objetivo principal es brindarle una atención personalizada desde el primer momento en que usted se contacte con nosotros; poder superar sus expectativas en <strong>viajes de turismo</strong>, negocios y/o placer brindándoles un servicio eficiente y oportuno. Para ello tenemos una amplia variedad de programas los cuales le mostramos en nuestra web esperando brindarles una mejor alternativa para cada destino teniendo en cuenta una tarifa competente en el mercado sin disminuir la calidad del viaje logrando su completo comfort. <br />
                               	      <br />
Nuestro Staff esta comprometido a informarlos de 
                                	    manera oportuna y actualizada de todo en cuanto usted necesite para realizar su viaje anhelado. <br />
                               	      <br />
                           	      Esperamos que disfrute su viaje con nosotros y seamos de su agrado y confianza. Los estaremos esperando.</p>
                                      <p>&nbsp;</p>
                                      <p class="texto_derecha"><span class="texto_derecha">Atentamente,<strong> J&amp;K Travel</strong></span>.</p>
                                  </div>
