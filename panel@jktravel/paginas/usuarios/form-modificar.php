...
header("Content-Type: text/html; charset=iso-8859-1");
	...
	$rst_query=mysql_query("SELECT * FROM jk_privilegio_user WHERE usuario='". $_REQUEST["usuario"]."';", $conexion);
  ...
  <div id="titulo_principal">
    ...
    <div id="contenido_total">
        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
            	<td>
                <form id="form1" name="form1" method="post" action="actualizar.php?usuario=<?php echo $_REQUEST["usuario"]; ?>">
            	  <table width="700" border="0" align="center" cellpadding="0" cellspacing="0">
            	    ...
            	    <tr>
            	      <td align="right"><p> <strong>
            	        <label> Nombre</label>
            	        : </strong></p></td>
            	      <td align="left"><input name="nombre" type="text" id="nombre" value="<?php echo $fila_query1["nombre"]; ?>" size="50" /></td>
          	      </tr>
            	    <tr>
            	      <td align="right"><p> <strong>
            	        <label> Apellidos:</label>
          	        </strong></p></td>
            	      <td align="left"><input name="apellidos" type="text" id="apellidos" value="<?php echo $fila_query1["apellidos"]; ?>" size="50" /></td>
          	      </tr>
            	    <tr>
            	      <td align="right"><p> <strong>
            	        <label> Email:</label>
            	      ...
            	      <td align="left"><span id="sprytextfield1">
            	        ...
            	        <span class="textfieldRequiredMsg">Ingrese un Email</span><span class="textfieldInvalidFormatMsg">Email no v&aacute;lido.</span></span></td>
          	      </tr>
            	    <tr>
            	      <td align="right"><p> <strong>
            	        <label> Usuario:</label>
          	        </strong></p></td>
            	      <td align="left"><input name="usuario" type="text" id="usuario" value="<?php echo $fila_query1["usuario"]; ?>" size="30" readonly="readonly" /></td>
          	      </tr>
            	    <tr>
            	      <td align="right"><p> <strong>
            	    ...
            	    <tr>
            	      ...
            	      <td align="left"><input name="clave" type="password" id="clave" value="<?php echo $fila_query1["clave"]; ?>" size="30" /></td>
          	      </tr>
            	    <tr>
            	      ...
            	      <td><span id="spryselect3">
            	        <select name="paquete" id="paquete">
            	          ...
            	          <?php
                            ...
                            {
                                if ($fila2["id"]==$fila_query["paquete"])
            	      ...
            	      <td><span id="spryselect5">
            	        <select name="formularios" id="formularios">
            	          ...
            	          <?php
                            ...
                            {
                                if ($fila4["id"]==$fila_query["formulario"])
            	      ...
            	      <td><span id="spryselect6">
            	        <select name="usuarios" id="usuarios">
            	          ...
            	          <?php
                            ...
                            {
                                if ($fila5["id"]==$fila_query["usuarios"])
            	      ...
            	      <td><span id="spryselect7">
            	        <select name="modificar" id="modificar">
            	          ...
            	          <?php
                            ...
                            {
                                if ($fila6["id"]==$fila_query["modificar"])
            	      ...
            	      <td><span id="spryselect8">
            	        <select name="eliminar" id="eliminar">
            	          ...
            	          <?php
                            ...
                            {
                                if ($fila7["id"]==$fila_query["eliminar"])
