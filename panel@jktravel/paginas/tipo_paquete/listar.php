...
include("../../conexion/conexion.php");
	...
	{
		$rst_query=mysql_query("SELECT * FROM jk_tipo_paquete WHERE id>0 ORDER BY nombre ASC;", $conexion);
		...
		$rst_query=mysql_query("SELECT * FROM jk_tipo_paquete WHERE id>0 ORDER BY nombre ASC LIMIT $inicio, $registros;", $conexion);
	...
	{
		$rst_query=mysql_query("SELECT * FROM jk_tipo_paquete WHERE nombre LIKE '%$buscar%' ORDER BY nombre ASC;", $conexion);
		$num_registros=mysql_num_rows($rst_query);
		...
		$rst_query=mysql_query("SELECT * FROM jk_tipo_paquete WHERE nombre LIKE '%$buscar%' ORDER BY nombre ASC LIMIT $inicio, $registros;", $conexion);
		$paginas=ceil($num_registros/$registros);
...
<link rel="stylesheet" type="text/css" href="../../css/style-listas.css">
    ...
    <div id="contenido">
            ...
            <thead>
                <tr class="titulo-campo">
                    <th width="50%" height="25">Tipo de paquete</th>
                    <?php 
  ...
  ?>
                <tr<?php echo alt($zebra); $zebra++; ?>>
                    <td width="50%"><p><?php echo $fila["nombre"]; ?></p></td>
