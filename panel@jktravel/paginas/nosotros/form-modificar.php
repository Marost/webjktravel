...
<input name="titulo" type="text" id="titulo" value="<?php echo $fila_inicio["titulo"]; ?>" size="50" />
                  </label></td>
                </tr>
                <tr>
                  <td colspan="5">&nbsp;</td>
                ...
                <tr>
                  <td colspan="5" align="center"><textarea class="ckeditor" cols="80" id="contenido" name="contenido" rows="10"><?php echo $fila_inicio["contenido"]; ?></textarea></td>
                </tr>
                <tr>
                  <td colspan="5">&nbsp;</td>
                </tr>
                    ...
                    <select name="idioma" id="idioma">
                      <option value="0">[ Seleccionar opcion ]</option>
						  <?php
                            ...
                            {
                                if ($fila1["id"]==$fila_inicio["idioma"])
                  ...
                  <td colspan="3"><span id="spryselect2">
                    <select name="publicar" id="publicar">
                      ...
                      <?php
                            ...
                            {
                                if ($fila1["id"]==$fila_inicio["publicar"])
