...
include("../../conexion/conexion.php");
	...
	{
		$rst_query=mysql_query("SELECT * FROM jk_embajadas WHERE id>0 ORDER BY pais ASC;", $conexion);
		...
		$rst_query=mysql_query("SELECT * FROM jk_embajadas WHERE id>0 ORDER BY pais ASC LIMIT $inicio, $registros;", $conexion);
	...
	{
		$rst_query=mysql_query("SELECT * FROM jk_embajadas WHERE pais LIKE '%$buscar%' ORDER BY pais ASC;", $conexion);
		$num_registros=mysql_num_rows($rst_query);
		...
		$rst_query=mysql_query("SELECT * FROM jk_embajadas WHERE pais LIKE '%$buscar%' ORDER BY pais ASC LIMIT $inicio, $registros;", $conexion);
		$paginas=ceil($num_registros/$registros);
...
<link rel="stylesheet" type="text/css" href="../../css/style-listas.css">
    ...
    <div id="contenido">
            	<div id="pregunta_principal">
            	  <h2>Lista - Visas y Embajadas</h2>
  ...
  ?>
                          <tr<?php echo alt($zebra); $zebra++; ?>>
                            <td width="50%"><p><?php echo $fila["pais"]; ?></p></td>
