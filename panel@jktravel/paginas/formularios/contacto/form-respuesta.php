            ...
            <tr>
                ...
                <form action="guardar.php" method="post" name="form1" id="form1">
            	  <table width="700" border="0" align="center" cellpadding="0" cellspacing="0">
            	    ...
            	    <tr>
            	      <td width="20%" height="30" align="left" class="texto_izq">
                ...
                <tr>
                  <td colspan="2" align="center"><input type="submit" name="guardar" id="guardar" value="Responder" />                    <label>
