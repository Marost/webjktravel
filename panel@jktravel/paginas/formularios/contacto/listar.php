...
$buscar=$_REQUEST["busqueda"];
		...
		$rst_query=mysql_query("SELECT * FROM jk_contacto WHERE id>0 AND respuesta<>1 ORDER BY id DESC;", $conexion);
		...
		$rst_query=mysql_query("SELECT * FROM jk_contacto WHERE id>0 AND respuesta<>1 ORDER BY id DESC LIMIT $inicio, $registros;", $conexion);
	...
	//PRIVILEGIOS USER
	$rst_query2=mysql_query("SELECT * FROM jk_privilegio_user WHERE usuario='$user'", $conexion);
...
<div id="contenido">
                ...
                <div id="contenido_total">
                  <table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                      <td colspan="2" align="left"><p><a href="descargar.php"><strong>Descargar todos los contacto</strong>s</a></p></td>
                  </tr>
                    <tr>
                  ...
                  <?php while($fila_query2=mysql_fetch_array($rst_query)){ ?>
                    <tr<?php echo alt($zebra); $zebra++; ?>>
                      <td width="50%"><p>ID: <?php echo $fila_query2["id"]; ?> | Por: <strong><?php echo $fila_query2["nombre"]; ?></strong>
                      </p></td>
