...
<form method="post" action="guardar_nuevo_destino.php">
<table width="700" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="29%" height="40">Nombre de Destino:</td>
    <td width="71%" height="40"><label>
      <input name="nombre_destino" type="text" id="nombre_destino" size="40" />
    </label></td>
  </tr>
  <tr>
    <td height="40">Nombre Paquete - Dias:</td>
    <td height="40"><label>
      <input name="paquete_dias" type="text" id="paquete_dias" size="40" />
    </label></td>
  </tr>
  <tr>
    <td height="40">Precio:</td>
    <td height="40"><label>
      <input name="nombre_precio" type="text" id="nombre_precio" size="40" />
    </label></td>
  </tr>
  <tr>
    <td height="40" colspan="2" align="center">
    	<textarea id="elm1" name="elm1" rows="25" cols="80" style="width: 80%"></textarea>
    </td>
    </tr>
  <tr>
  ...
  <tr>
    ...
    <td height="40"><label>
      <input name="retorno" type="text" id="retorno" />
    </label></td>
  </tr>
  <tr>
