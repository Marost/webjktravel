...
include("conexion/conexion.php");
	...
	$rst_datos=mysql_query("SELECT * FROM jk_empresa WHERE id=1;", $conexion);
...
<body>
<div id="principal">
	<div class="texto_regresar" id="superior_regresar">&nbsp;&nbsp;&nbsp;<a href="<?php echo $fila_datos["../admin/web"]; ?>">&lt;&lt; Volver a <?php echo $fila_datos["nombre"]; ?></a></div><!-- FIN TEXTO REGRESAR -->
    <div id="contenido">
